	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agri-Market Inc<span>Rau,Indore</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">7000******</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:Agri-Market@gmail.com" style="color:white">agrimarket@gmail.com</a></p>
			</div>
		</div>
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
									<div class="3u 12u$(xsmall)">
										<input type="tel" name="mobile" id="mobile" value="" placeholder="Mobile Number" required maxlength="10">
									</div>
